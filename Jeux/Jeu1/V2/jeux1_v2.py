...
def main_menu_v2(): #MENU
    while True:
        screen.blit(scaled_image, (0, 0))

        MENU_MOUSE_POS = pygame.mouse.get_pos()

        MENU_TEXT = get_font(100).render("MENU J2", True, "#03BC00")
...
def options():
    while True:
        ...
        MENU_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(683, 675), 
                            text_input="MENU", font=get_font(75), base_color="Cyan", hovering_color="Red")
        screen.blit(MENU_TEXT, MENU_RECT)

        for button in [MENU_BUTTON, A_BUTTON, B_BUTTON, C_BUTTON, D_BUTTON, E_BUTTON, F_BUTTON]:
            button.changeColor(MENU_MOUSE_POS)
            button.update(screen)
...
def level(): #LEVEL
    ...
    while True:
        ...
        MENU_BUTTON = Button(image=pygame.image.load("assets/Quit Rect.png"), pos=(centre, 675), 
                            text_input="MENU", font=get_font(75), base_color="Cyan", hovering_color="White")


        screen.blit(MENU_TEXT, MENU_RECT)


        for button in [I, II, III, IV, V, VI, VII, VIII, IX, X, XI, XII, XIII, XIV, XV, XVI, MENU_BUTTON]:
            button.changeColor(MENU_MOUSE_POS)
            button.update(screen)            
...
def pause():
    ...
    while a:
        ...
        for button in [RESET_BUTTON, PLAY_BUTTON, OPTIONS_BUTTON, QUIT_BUTTON]:
            button.changeColor(MENU_MOUSE_POS)
            button.update(screen)
